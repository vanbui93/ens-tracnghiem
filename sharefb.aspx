...
<head runat="server">
    ...
    <meta id="idOgIitle" property="og:title" content="Trắc nghiệm kiến thức Marketing - IQ" />
     <% 
      var corr=Int32.Parse(Request.Params["corr"]);
      var plainTextBytes = System.Text.Encoding.UTF8.GetBytes(Request.Params["name"]);
      var nameCode = System.Convert.ToBase64String(plainTextBytes);
   ...
   <%Response.Write(img); %> 
    ...
    <meta property="og:site_name" content="hocbong.enschannel.com" />
   
</head>
<body onload="window.location.href = 'http://hocbong.enschannel.com'">
